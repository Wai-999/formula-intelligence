...
export const MIXED_REVIEW_QUESTIONS = [
  {
    ...
    options: [
      blSame('Real yields — the price falls overall', 'Real yields — ဈေးနှုန်း ကျဆင်းသွားမည်'),
      blSame('The geopolitical shock — the price rises overall', 'ပထဝီရေး shock — ဈေးနှုန်း တက်လာမည်'),
      blSame('They cancel out exactly, no net move', 'အပြန်အလှန် ပယ်ဖျက်ပြီး ဘာမှမပြောင်း'),
    ],
    correctIndex: 1,
    explanation: blSame(
  ...
  },
  {
    ...
    options: [
      blSame('Yes — Random Forest wins at every forecasting task', 'ဟုတ်သည် — Random Forest သည် forecasting task တိုင်းတွင် အနိုင်ရသည်'),
      blSame('Not necessarily — Module 8 highlights Gradient Boosting specifically, for a different reason (capturing promotions/thresholds, not averaging noisy signals)', 'မလိုအပ်ပါ — Module 8 က Gradient Boosting ကို အထူးပြထားသည်၊ အကြောင်းရင်း မတူညီပါ (promotion/threshold ဖမ်းယူခြင်း၊ noisy signal ပျမ်းမျှခြင်း မဟုတ်ပါ)'),
      blSame('No — no model comparison applies to price elasticity at all', 'မဟုတ်ပါ — ဈေးနှုန်း elasticity အတွက် model နှိုင်းယှဉ်မှု မသက်ဆိုင်ပါ'),
    ],
    correctIndex: 1,
    explanation: blSame(
  ...
  },
  {
    ...
    options: [
      blSame('Yes — ARIMA can outperform LSTM/XGBoost when the relationship is stable and roughly linear', 'ဟုတ်သည် — ဆက်နွယ်မှု တည်ငြိမ်ပြီး linear နီးပါးလျှင် ARIMA သည် LSTM/XGBoost ကို အနိုင်ရနိုင်သည်'),
      blSame('No — the research doc always favors the most complex model for Gold', 'မဟုတ်ပါ — သုတေသနစာတမ်းက Gold အတွက် အရှုပ်ထွေးဆုံး model ကို အမြဲနှစ်သက်သည်'),
      blSame('No — model complexity has no bearing on Gold forecasts', 'မဟုတ်ပါ — model ရှုပ်ထွေးမှုသည် Gold forecast အပေါ် ဘာမှသက်ရောက်မှုမရှိပါ'),
    ],
    correctIndex: 0,
    explanation: blSame(
  ...
  },
  {
    ...
    options: [
      blSame("Nothing — Gold's math is independent of how the score was built", 'ဘာမှမဖြစ်ပါ — Gold ရဲ့ တွက်ချက်မှုသည် score ကို ဘယ်လိုတည်ဆောက်ခဲ့လဲဆိုတာနှင့် သီးခြားဖြစ်သည်'),
      blSame("The bias flows straight through — Gold's model can't tell a skewed score from an accurate one, it just reacts to the number it's given", 'Bias တိုက်ရိုက် စီးဆင်းလာသည် — Gold ၏ model သည် skew ဖြစ်နေသော score ကို တိကျသော score နှင့် ခွဲခြားမသိနိုင်ပါ၊ ပေးထားသော ဂဏန်းကို တုံ့ပြန်ရုံသာ'),
      blSame('Gold automatically corrects for any known bias upstream', 'Gold သည် upstream ရှိ သိထားသော bias ကို အလိုအလျောက် ပြင်ဆင်ပေးသည်'),
    ],
    correctIndex: 1,
    explanation: blSame(
